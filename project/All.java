...
/**
 * Created by Harshith Desamsetti on 24-04-2018.
 */
...
public class All extends AppCompatActivity {
    ...
    public void setupQuestion() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (n == 1) {
                ...
                questionModelArrayList.add(new QuestionModel("What is " + n1 + "X" + n2 + "?", x));
            } else if (n == 2) {
                int n3 = n1 + n2;
                String x = String.valueOf(n3);
    ...
    public void setData() {
        if (questionModelArrayList.size() > currentPosition) {
            ...
            new SweetAlertDialog(All.this,SweetAlertDialog.SUCCESS_TYPE)
    ...
    public void checkAnswer() {
        ...
        if (answerString.equalsIgnoreCase(questionModelArrayList.get(currentPosition).getAnswer())) {
            ...
            new SweetAlertDialog(All.this,SweetAlertDialog.ERROR_TYPE)

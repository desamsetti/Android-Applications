...
public class Division extends AppCompatActivity {
    ...
    public void setupQuestion(){
        ...
        for(int i=0;i<10;i++) {
            ...
            int y = n3/n1;
            x = String.valueOf(y);
            questionModelArrayList.add(new QuestionModel("What is " + n3 + "/" + n1 + "?", x));
            }
    }
    ...
    public void setData() {
        if (questionModelArrayList.size() > currentPosition) {
            ...
            new SweetAlertDialog(Division.this,SweetAlertDialog.SUCCESS_TYPE)
    ...
    public void checkAnswer() {
        ...
        if (answerString.equalsIgnoreCase(questionModelArrayList.get(currentPosition).getAnswer())) {
            ...
            new SweetAlertDialog(Division.this,SweetAlertDialog.ERROR_TYPE)
